...
## Clock signal
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { IO_CLK }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
## LEDs
set_property -dict { PACKAGE_PIN T22    IOSTANDARD LVCMOS33 } [get_ports { LED1[0] }]; #IO_L24N_T3_35 Sch=led[4]
set_property -dict { PACKAGE_PIN T21    IOSTANDARD LVCMOS33 } [get_ports { LED1[1] }]; #IO_25_35 Sch=led[5]
set_property -dict { PACKAGE_PIN U22    IOSTANDARD LVCMOS33 } [get_ports { LED1[2] }]; #IO_L24P_T3_A01_D17_14 Sch=led[6]
set_property -dict { PACKAGE_PIN U21    IOSTANDARD LVCMOS33 } [get_ports { LED1[3] }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]

set_property -dict { PACKAGE_PIN V22    IOSTANDARD LVCMOS33 } [get_ports { LED2[0] }]; #IO_L24N_T3_35 Sch=led[4]
set_property -dict { PACKAGE_PIN W22    IOSTANDARD LVCMOS33 } [get_ports { LED2[1] }]; #IO_25_35 Sch=led[5]
set_property -dict { PACKAGE_PIN U19    IOSTANDARD LVCMOS33 } [get_ports { LED2[2] }]; #IO_25_35 Sch=led[5]
set_property -dict { PACKAGE_PIN U14    IOSTANDARD LVCMOS33 } [get_ports { LED2[3] }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]
## Buttons
...
set_property -dict { PACKAGE_PIN F22    IOSTANDARD LVCMOS33 } [get_ports { IO_RST_N }]; #IO_L16P_T2_35 Sch=ck_rst
